                ...
                <div className="row">
                    <div className="col-lg-4 d-flex align-items-stretch">
                        <div className="content">
                            <h3>Why Choose Us?</h3>
                            <p>
                            MediConnect offers seamless appointment scheduling, real-time communication with doctors, and integrated medical store access—all in one user-friendly interface. Experience efficient healthcare management with 24/7 support and secure data handling tailored to meet your needs.
                            </p>
